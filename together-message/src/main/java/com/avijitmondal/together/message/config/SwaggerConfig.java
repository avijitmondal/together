package com.avijitmondal.together.message.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.avijitmondal.together.message.controller"))
    ...
    private ApiInfo generateAPIInfo() {
        return new ApiInfo("together-message Swagger", "Swagger for together-message", "1.0",
