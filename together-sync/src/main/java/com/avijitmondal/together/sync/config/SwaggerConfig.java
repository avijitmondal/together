package com.avijitmondal.together.sync.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.avijitmondal.together.sync.controller"))
    ...
    private ApiInfo generateAPIInfo() {
        return new ApiInfo("together-sync Swagger", "Swagger for together-sync", "1.0",
